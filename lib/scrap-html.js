...
const selectValidation = ($, el) => {
  if($("td", el).eq(8).text()) {
    return {
      waktu_imsyak: $("td", el).eq(3).text(),
      waktu_subuh:  $("td", el).eq(4).text(),
      waktu_dhuhur: $("td", el).eq(5).text(),
      waktu_asar:   $("td", el).eq(6).text(),
      waktu_magrib: $("td", el).eq(7).text(),
      waktu_isya:   $("td", el).eq(8).text()
    }
  }
  return {
    waktu_imsyak: undefined,
    waktu_subuh:  $("td", el).eq(3).text(),
    waktu_dhuhur: $("td", el).eq(4).text(),
    waktu_asar:   $("td", el).eq(5).text(),
    waktu_magrib: $("td", el).eq(6).text(),
    waktu_isya:   $("td", el).eq(7).text()
  }
}
